...
def purpose():
     ...
     while True:
        ...
        SCREEN.blit(bot, (10, 95))
        bot = CONVERSATION.render("and even entertain you throught text messages.", 1, "blue")
        SCREEN.blit(bot, (10, 140))
        me = CONVERSATION.render("ME: ...", 1, "black")
...
def india():
     ...
     while True:
        ...
        SCREEN.blit(me, (10, 10))
        bot = CONVERSATION.render("BOT: Glad to talk to an Indian. You are definately one of the", 1, "blue")
        SCREEN.blit(bot, (10, 55))
        bot = CONVERSATION.render("precious gems of this country.", 1, "blue")
...
def foreigner():
     ...
     while True:
        ...
        SCREEN.blit(me, (10, 10))
        bot = CONVERSATION.render("BOT: Wow, are you seriously a foreigner! Can't beleive! Nice", 1, "blue")
        SCREEN.blit(bot, (10, 55))
        bot = CONVERSATION.render("to meet the first foreigner of the day.", 1, "blue")
        SCREEN.blit(bot, (10, 100))
        bot = CONVERSATION.render("Well, can I know you na...", 1, "blue")
        SCREEN.blit(bot, (10, 145))
        key_press = PRESS_KEY_FONT.render("Press 'Z' to continue", 1, "black")
...
def end_screen():
     ...
     while run:
          ...
          end = END_SCREEN_FONT.render("Actually it was a call form Musk, SpaceX.", 1, "blue")
